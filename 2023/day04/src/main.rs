...
fn main() {
    ...
    env_logger::init();
    let filename = "2023/day04/input.txt";
...
pub fn get_points(s: &str) -> u32 {
    let nums = get_numbers(s);
    let wins = get_winning_numbers(s);
    let mut nb_wins = 0;
    for n in nums {
...
mod tests {
    ...
    fn test_get_card_id() {
        assert_eq!(
            get_card_id("Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53"),
            1
        );
        assert_eq!(
            get_card_id("Card 2: 13 32 20 16 61 | 61 30 68 82 17 32 24 19"),
            2
        );
    }
    #[test]
    ...
    #[test]
    fn test_get_points() {
        let p = get_points("Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53");
        assert_eq!(p, 8)
    }

    #[test]
    fn test_get_points_file() {
        env_logger::init();
